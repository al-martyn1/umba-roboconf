  ...
  - [Правила](#user-content-правила)
    - [Шаблоны правил](#user-content-шаблоны-правил)
      - [Формат описания правил](#user-content-формат-описания-правил)
        - [Шаблонные атомы](#user-content-шаблонные-атомы)
        - [Модификаторы атомов](#user-content-модификаторы-атомов)
        - [Списки значений L](#user-content-списки-значений-l)
        ...
        - [Вложенный список I](#user-content-вложенный-список-i)
        - [Отображение значений M](#user-content-отображение-значений-m)
        - [vectorVector E](#user-content-vectorvector-e)
...
#### Отображение значений M

Атом jтображениz значений `M` поддерживает следующие модификаторы: `s`, `i`, `#`, `$`, `+`.
...
```
netlist.h:103
ROBOCONF_PARSE_READ_LIST_BY_TEMPLATE( "Ti:edif;V
netlist.h:125
ROBOCONF_PARSE_READ_LIST_BY_TEMPLATE( "Ti:edifVersion;V;V;V"
```
...
packages.cpp:339
ROBOCONF_PARSE_READ_LIST_BY_TEMPLATE( "V;Ti:numpins;V;A$"
packages.cpp:408
ROBOCONF_PARSE_READ_LIST_BY_TEMPLATE( "V;A+$"
```
